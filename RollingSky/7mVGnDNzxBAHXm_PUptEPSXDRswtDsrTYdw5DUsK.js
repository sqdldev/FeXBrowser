...
if (fgnc == 1) {
   ...
   $('#level-view').html('<img src="RAA/RAA_12.png" width="375px">');
} else if (fgnc == 14) {
   ...
   $('#level-view').html('<img src="RAA/RAA_14.png" width="375px">');
} else if (fgnc == 36) {
   ...
   $('#level-view').html('<img src="RAA/RAA_36.png" width="375px">');
} else if (fgnc == 39) {
