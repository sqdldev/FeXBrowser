...
if (fgnc == "Function_Setting") {
   ...
   $('#Main_Title').html('APP');
   $('#Main_Menu').html('<div class="s_bar" align="center"/><h3 align="left">　Rolling Sky Evolution</h3><img align="center" width="200px" src="ic/Rolling Sky Evolution icon.png"><hr size="3"/><h5>ローリングスカイの二次創作ゲームがWEBとAndroidアプリで登場！超難易度の鬼畜ステージのクリアを目指せ！</h5><hr size="3"/><h3 align="center"><a href="https://figseu-technology.github.io/RollingSkyEvolution/index.html">Play (Browser)</a></h3><hr size="3"/></div>');
